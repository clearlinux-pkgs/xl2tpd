...
Source0  : https://github.com/xelerance/xl2tpd/archive/v1.3.18/xl2tpd-1.3.18.tar.gz
...
%prep
%setup -q -n xl2tpd-1.3.18
cd %{_builddir}/xl2tpd-1.3.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667427519
...
cp %{_builddir}/xl2tpd-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/xl2tpd/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/xl2tpd-%{version}/debian/copyright %{buildroot}/usr/share/package-licenses/xl2tpd/4031a67e08668e88c201419943bcfd6b7bf3c2cd
...
/usr/share/package-licenses/xl2tpd/4031a67e08668e88c201419943bcfd6b7bf3c2cd
