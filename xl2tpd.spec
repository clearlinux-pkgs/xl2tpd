...
Version  : 1.3.17
Release  : 3
URL      : https://github.com/xelerance/xl2tpd/archive/v1.3.17/xl2tpd-1.3.17.tar.gz
Source0  : https://github.com/xelerance/xl2tpd/archive/v1.3.17/xl2tpd-1.3.17.tar.gz
...
%prep
%setup -q -n xl2tpd-1.3.17
cd %{_builddir}/xl2tpd-1.3.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644451893
...
cp %{_builddir}/xl2tpd-1.3.17/LICENSE %{buildroot}/usr/share/package-licenses/xl2tpd/4cc77b90af91e615a64ae04893fdffa7939db84c
