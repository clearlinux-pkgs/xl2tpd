...
Version  : 1.3.16
Release  : 2
URL      : https://github.com/xelerance/xl2tpd/archive/v1.3.16/xl2tpd-1.3.16.tar.gz
Source0  : https://github.com/xelerance/xl2tpd/archive/v1.3.16/xl2tpd-1.3.16.tar.gz
...
%prep
%setup -q -n xl2tpd-1.3.16
cd %{_builddir}/xl2tpd-1.3.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604945190
...
cp %{_builddir}/xl2tpd-1.3.16/LICENSE %{buildroot}/usr/share/package-licenses/xl2tpd/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/xl2tpd-1.3.16/debian/copyright %{buildroot}/usr/share/package-licenses/xl2tpd/f0e740a6bb96e38a721f7f59733e78a785f44446
